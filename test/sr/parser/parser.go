...
import errs "code.google.com/p/gocc/test/sr/errors"

import "code.google.com/p/gocc/test/sr/token"
...
func (this Reduce) String() string { return fmt.Sprintf("Reduce:%d(%s)", this, ProductionsTable[this].String) }
