...
var productionsTable = ProdTab{
	...
	ProdTabEntry{
		String: `StmtList : Π<Stmt_s>	<< func() (retval interface{}, err error) {
  ...
  return
		...
		NumSymbols: 1,
		ReduceFunc: func(Context interface{}, X []Attrib) (Attrib, error) {
			return func() (retval interface{}, err error) {
				fmt.Printf("%s", summary(X[0]))
				retval, err = 42, nil
				return
			}()
		},
	...
	ProdTabEntry{
		String: `Stmt_s : Π<Stmt>	<< first_one($0s),nil >>`,
		Id:         "Stmt_s",
		NTType:     2,
		Index:      2,
		NumSymbols: 1,
		ReduceFunc: func(Context interface{}, X []Attrib) (Attrib, error) {
			return first_one(getString(X[0])), nil
		},
	},
	ProdTabEntry{
		String: `Stmt_s : Π<Stmt_s> Λ<;> Π<Stmt>	<< add_one($0.([]string),$2s),nil >>`,
		Id:         "Stmt_s",
		NTType:     2,
		Index:      3,
		NumSymbols: 3,
		ReduceFunc: func(Context interface{}, X []Attrib) (Attrib, error) {
			return add_one(X[0].([]string), getString(X[2])), nil
		},
	},
	ProdTabEntry{
