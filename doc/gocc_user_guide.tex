...
\section{Example: reduce/reduce conflict handling} \label{sec:example rr}
	...
	\verb|$GOPATH/src/github.com/goccmack/gocc/example/reducereduce|
	...
	When we run \gocc on \verb|$GOPATH/src/github.com/goccmack/gocc/example/reducereduce/rr.bnf| we discover a reduce/reduce conflict:
	...
	\verb|$GOPATH/src/github.com/goccmack/gocc/example/reducereduce/sm_sets.txt|
...
\section{Example: Shift/reduce conflict handling} \label{sec:example sr}
	...
	\verb|$GOPATH/src/github.com/goccmack/gocc/example/shiftreduce|
	...
	When we run \gocc on \verb|$GOPATH/src/github.com/goccmack/gocc/example/shiftreduce/sr.bnf| we discover a shift/reduce conflict:
